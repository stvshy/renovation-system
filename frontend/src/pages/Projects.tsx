    ...
    return (
        ...
        <div className="flex flex-1 justify-center p-4 sm:p-6 md:p-8 [scrollbar-gutter:stable]">
            <div className="flex flex-col w-full max-w-7xl mx-auto">
                <header className="flex items-center justify-between gap-3 sm:gap-4 mb-2 sm:mb-6">
                    ...
                    <button
                        ...
                        aria-label={t('Nowy Projekt', 'New Project')}
                    >
                        <span className="material-symbols-outlined text-[20px] leading-none">add</span>
                    </button>
                    <button
                        onClick={() => navigate('/projects/new/client')}
                        className="hidden sm:flex w-full sm:w-auto items-center justify-center gap-2 overflow-hidden rounded-xl h-[46.2px] px-5 bg-primary text-white text-sm font-bold tracking-wide hover:bg-primary/90 transition-colors shadow-sm"
                    >
                ...
                {/* Status Tabs */}
                <div className="flex justify-center py-1 sm:py-2 -mx-1 mb-2">
                                        ...
                                        <div className="flex flex-col justify-center flex-grow min-w-0">
                                            <div className="flex w-full min-w-0 items-center gap-[9px] sm:gap-2">
                                                ...
                                                <span className={`ml-auto sm:ml-0 inline-flex items-center text-[10px] px-2 py-0.5 rounded-full uppercase font-bold whitespace-nowrap ${
                                                    ...
                                                    <span className="2xl:translate-y-[0.5px]">{t('Roboczy', 'Draft')}</span>
                                                </span>
                                            </div>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col justify-center flex-grow min-w-0">
                                        <div className="flex w-full min-w-0 items-center gap-[9px] sm:gap-2">
                                            ...
                                            >
                                                <span className="block max-w-full truncate whitespace-nowrap 2xl:translate-y-[0.5px]">
                                            ...
                                            <span className={`hidden sm:inline-flex items-center text-[10px] px-2 py-0.5 rounded-full uppercase font-bold whitespace-nowrap
                                                ${project.status === 'Completed' ? 'bg-green-100 text-green-700' :
                                                  ...
                                                  'bg-blue-100 text-blue-700'}`}
                                            >
                                                <span className="2xl:translate-y-[0.5px]">{statuses.find(s => s.value === project.status)?.label || project.status}</span>
                                            </span>
                                        </div>
                                        <p className="text-slate-500 dark:text-slate-400 text-[13px] sm:text-sm font-normal leading-normal line-clamp-2">
