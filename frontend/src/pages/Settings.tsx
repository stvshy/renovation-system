                                        ...
                                        <div className="mt-2 text-sm text-gray-500 dark:text-gray-400 space-y-1">
                                            <p className="flex justify-between">
                                                ...
                                                <span className="font-semibold text-gray-700 dark:text-gray-300">
                                                    {service.laborRate} zł/{service.defaultStrategy === "item" ? "szt" : "m²/mb"}
                                                </span>
                                            </p>
                                            <p className="flex justify-between">
                                                <span>Strategia:</span>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-lg animate-fade-in relative">
                        <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-slate-800 rounded-t-2xl">
                            <h2 className="text-lg font-bold text-slate-900 dark:text-white">{editingItem ? "Edytuj Usługę" : "Nowa Usługa"}</h2>
                            <button
                                        ...
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <div className="group relative inline-flex items-center justify-center">
                                                ...
                                                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 p-4 bg-slate-800 text-white text-xs rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[60] pointer-events-none transform -translate-y-2 group-hover:translate-y-0">
                                                    <p className="font-bold mb-2 text-primary border-b border-gray-600 pb-2 text-sm">Logika obliczeń:</p>
                                                    <ul className="space-y-3">
                                                        <li>
                                                            <span className="font-bold text-blue-300 block mb-0.5">Zużycie (m²/l)</span>
                                                            <span className="text-gray-300">System dzieli powierzchnię przez wydajność.</span>
                                                            <br />
                                                            <span className="text-gray-400 italic font-mono text-[10px]">Wzór: Powierzchnia / Wydajność</span>
                                                        </li>
                                                        <li>
                                                            <span className="font-bold text-blue-300 block mb-0.5">Odpad (%)</span>
                                                            <span className="text-gray-300">Dodaje % zapasu na docinki do powierzchni.</span>
                                                            <br />
                                                            <span className="text-gray-400 italic font-mono text-[10px]">Wzór: Powierzchnia * (1 + %)</span>
                                                        </li>
                                                        <li>
                                                            <span className="font-bold text-blue-300 block mb-0.5">Liniowy (mb)</span>
                                                            <span className="text-gray-300">Jak odpad, ale dla metrów bieżących (listwy).</span>
                                                        </li>
                                                        <li>
                                                            <span className="font-bold text-blue-300 block mb-0.5">Na sztuki</span>
                                                            <span className="text-gray-300">Proste zliczanie ilości.</span>
                                                        </li>
                                                    </ul>
