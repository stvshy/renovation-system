            ...
            <div className="layout-content-container flex flex-col w-full max-w-[1280px] flex-1">
                <div className="flex flex-col gap-2 border-b border-gray-200 dark:border-gray-700 pt-0 pb-4 px-2 sm:pt-4 sm:px-4">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-1.5 sm:pt-1">
                        <button type="button" className="text-[11.5px] sm:text-[11.9px] font-bold rounded-lg border border-primary bg-white dark:bg-slate-900 px-[10.3px] py-[4.4px] text-primary">
                            {t('Krok 1', 'Step 1')}
                        </button>
                        <button
                            type="button"
                            onClick={() => navigate('/projects/new/room', { state: buildWizardState() })}
                            className="text-[11.5px] sm:text-[11.9px] font-bold rounded-lg border border-slate-300 dark:border-slate-600 px-2.5 sm:px-[10.3px] py-1 sm:py-[4.4px] text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800"
                        >
                            {t('Krok 2', 'Step 2')}
                        </button>
                        <button
                ...
                <div className="flex flex-col gap-4 px-2 sm:px-4 pt-4 pb-0 sm:py-4">
                    ...
                    {isEditMode ? (
                        <div className="flex justify-end px-0 mt-2 pt-6 pb-2 border-t border-gray-200 dark:border-gray-700 w-full sm:mt-6 sm:py-4 sm:pt-6">
                            <button
                                onClick={handleNext}
                        ...
                        <div className="flex flex-row md:flex-row gap-3 px-3 sm:px-4 mt-2 pt-6 pb-2 border-t border-gray-200 dark:border-gray-700 w-full justify-between md:justify-end md:items-center sm:mt-6 sm:py-4 sm:pt-6">
